        ...
        for numWayside in range(numWaysides):
            ...
            for numBlock in range(len(waysideBlocks[numWayside])):
                ...
                if(blockNumberCount in defaultBlocks):
                    ...
                    track.lines[0].waysides[numWayside].blocks[numBlock].stationName = ""
                    ...
                    track.lines[0].waysides[numWayside].blocks[numBlock].trafficLightColor = "Green"
                    if(blockNumberCount in junctionSwitch):
                        ...
                        track.lines[0].waysides[numWayside].blocks[numBlock].switchDirection = str(junctionSwitch[0]) + "-" + str(junctionReceiver[1])
                    ...
                    track.lines[0].waysides[numWayside].blocks[numBlock].crossingActive = "False"

                # Default other stuff
                track.lines[0].waysides[numWayside].blocks[numBlock].trackFaultDetected = "False"
                track.lines[0].waysides[numWayside].blocks[numBlock].maintenanceActive = "False"
